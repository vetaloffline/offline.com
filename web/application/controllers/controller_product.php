...
class Controller_product extends Controller
{
	...
	{	
		...
		$this->mean_img = $this->model->makeImg_meanGood($id);

		$this->view->generate('product_view.php', 'template_view.php',$db,$this->good,$this->colors,$this->small_img,$this->mean_img);
