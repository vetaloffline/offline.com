				...
				<div class="otz_opis">
					<div class="reiting">
						<div class="reiting1">
							<a hre="#" >
							<?
							if($goods["rating"]==0){echo "<a href='#otziv' class='reiting2'><img src='web/static/img/r0.png'class='reiting2'></a>";}
							if($goods["rating"]==0.5){echo "<a href=''><img src='web/static/img/r05.png'class='reiting2'></a>";}
							if($goods["rating"]==1){echo "<a href=''><img src='web/static/img/r1.png'class='reiting2'></a>";}
							if($goods["rating"]==1.5){echo "<a href=''><img src='web/static/img/r15.png'class='reiting2'></a>";}
							if($goods["rating"]==2){echo "<a href=''><img src='web/static/img/r2.png'class='reiting2'></a>";}
							if($goods["rating"]==2.5){echo "<a href=''><img src='web/static/img/r25.png'class='reiting2'></a>";}
							if($goods["rating"]==3){echo "<a href=''><img src='web/static/img/r3.png'class='reiting2'></a>";}
							if($goods["rating"]==3.5){echo "<a href=''><img src='web/static/img/r35.png'class='reiting2'></a>";}
							if($goods["rating"]==4){echo "<a href=''><img src='web/static/img/r4.png'class='reiting2'></a>";}
							if($goods["rating"]==4.5){echo "<a href=''><img src='web/static/img/r45.png'class='reiting2'></a>";}
							if($goods["rating"]==5){echo "<a href=''><img src='web/static/img/r5.png' class='reiting2'></a>";}
							?>
							</a>
						</div>
						<div class="reviews">
